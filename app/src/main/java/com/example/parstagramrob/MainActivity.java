...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edDiscription = findViewById(R.id.edDescription);
     ...
     //   queryPosts();
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String description = edDiscription.getText().toString();
                if (description.isEmpty()){
                    Toast.makeText(MainActivity.this, "Description cannot be empty" , Toast.LENGTH_SHORT);
                    return;
                }
                if (photoFile == null || ivpostImage.getDrawable() == null){
                    Toast.makeText(MainActivity.this, "There is no image to display" , Toast.LENGTH_SHORT);
                    return;
                }
